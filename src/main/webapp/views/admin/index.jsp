	...
	<div class="container-fluid">
		<div class="row content">
			<div class="col-sm-2 sidenav hidden-xs">
					...
					<li><a href="#" data-toggle="collapse"
						...
						<ul class="nav nav-pills nav-stacked collapse" id="myNavbar1">
							...
							<li class="text-center"><a href="/admin/category"><span
									class="glyphicon glyphicon-hand-right"></span> Quản Lý Danh Mục</a></li>
						</ul></li>
				...
				<ul class="nav nav-pills nav-stacked text-lg text-danger" style="padding-top: 20cm;">
					<li><a href="/login" class="text-danger"> <span
								class="glyphicon glyphicon-log-in text-danger"></span> Đăng Xuất
						</a></li>
				</ul>
			</div>
			<br>
